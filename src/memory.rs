...
use x86_64::structures::paging::{Page, PageTable,PhysFrame, Mapper, Size4KiB, FrameAllocator, OffsetPageTable};
...
pub unsafe fn init(physical_mem_offset: VirtAddr) -> OffsetPageTable<'static> {
    let level_4_page_table = active_level_4_table(physical_mem_offset);
    OffsetPageTable::new(level_4_page_table, physical_mem_offset)
}
